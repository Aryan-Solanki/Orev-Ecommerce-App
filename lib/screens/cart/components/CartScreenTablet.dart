...
class CartScreenTablet extends StatefulWidget {
  final List<dynamic> keys;
  final Map currentAddress;
  final Function(Map) notifyParent;
  const CartScreenTablet({
    Key key,
    this.keys,
  ...
  @override
  CartScreenTabletState createState() =>
      CartScreenTabletState(keys: keys, currentAddress: currentAddress);
}

class CartScreenTabletState extends State<CartScreenTablet> {
  Map currentAddress;
  List<dynamic> keys;
  CartScreenTabletState({@required this.keys, this.currentAddress});
...
class _AddressHeaderState extends State<AddressHeader> {
  final GlobalKey<CartScreenTabletState> myCartScreenState =
      GlobalKey<CartScreenTabletState>();
