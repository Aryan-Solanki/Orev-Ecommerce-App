...
class CartScreenDesktop extends StatefulWidget {
  ...
  @override
  CartScreenDesktopState createState() =>
      CartScreenDesktopState(keys: keys, currentAddress: currentAddress);
}

class CartScreenDesktopState extends State<CartScreenDesktop> {
  Map currentAddress;
  List<dynamic> keys;
  CartScreenDesktopState({@required this.keys, this.currentAddress});
...
class _AddressHeaderState extends State<AddressHeader> {
  final GlobalKey<CartScreenDesktopState> myCartScreenState =
      GlobalKey<CartScreenDesktopState>();
