...
class SearchPageMobile extends StatefulWidget {
  ...
  final String title;
  SearchPageMobile({this.productList, this.title});
  @override
  _SearchPageMobileState createState() =>
      _SearchPageMobileState(productList: productList);
}

class _SearchPageMobileState extends State<SearchPageMobile> {
  final List<Product> productList;
  _SearchPageMobileState({this.productList});
