...
class SearchPageTablet extends StatefulWidget {
  ...
  final String title;
  SearchPageTablet({this.productList, this.title});
  @override
  _SearchPageTabletState createState() =>
      _SearchPageTabletState(productList: productList);
}

class _SearchPageTabletState extends State<SearchPageTablet> {
  final List<Product> productList;
  _SearchPageTabletState({this.productList});
