...
class MyAccountTablet extends StatefulWidget {
  @override
  _MyAccountTabletState createState() => _MyAccountTabletState();
}

class _MyAccountTabletState extends State<MyAccountTablet> {
  String authkey = "";
  String name = "";
