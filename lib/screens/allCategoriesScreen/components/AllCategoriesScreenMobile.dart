...
class AllCategoriesScreenMobile extends StatefulWidget {
  final Function() notifyParent;
  AllCategoriesScreenMobile({this.notifyParent});
  @override
  _AllCategoriesScreenMobileState createState() =>
      _AllCategoriesScreenMobileState();
}

class _AllCategoriesScreenMobileState extends State<AllCategoriesScreenMobile> {
