...
class AllCategoriesScreenTablet extends StatefulWidget {
  final Function() notifyParent;
  AllCategoriesScreenTablet({this.notifyParent});
  @override
  _AllCategoriesScreenTabletState createState() =>
      _AllCategoriesScreenTabletState();
}

class _AllCategoriesScreenTabletState extends State<AllCategoriesScreenTablet> {
