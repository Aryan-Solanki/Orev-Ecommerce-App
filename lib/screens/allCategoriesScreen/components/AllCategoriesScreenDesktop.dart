...
class AllCategoriesScreenDesktop extends StatefulWidget {
  final Function() notifyParent;
  AllCategoriesScreenDesktop({this.notifyParent});
  @override
  _AllCategoriesScreenDesktopState createState() =>
      _AllCategoriesScreenDesktopState();
}

class _AllCategoriesScreenDesktopState
    extends State<AllCategoriesScreenDesktop> {
