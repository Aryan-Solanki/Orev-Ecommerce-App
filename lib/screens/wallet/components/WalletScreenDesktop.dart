...
class WalletScreenDesktop extends StatefulWidget {
  @override
  _WalletScreenDesktopState createState() => _WalletScreenDesktopState();
}

class _WalletScreenDesktopState extends State<WalletScreenDesktop> {
