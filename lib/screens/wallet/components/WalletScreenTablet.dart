...
class WalletScreenTablet extends StatefulWidget {
  @override
  _WalletScreenTabletState createState() => _WalletScreenTabletState();
}

class _WalletScreenTabletState extends State<WalletScreenTablet> {
