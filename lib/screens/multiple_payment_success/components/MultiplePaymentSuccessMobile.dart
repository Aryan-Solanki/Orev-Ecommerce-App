...
class MultiplePaymentSuccessMobile extends StatefulWidget {
  final bool transaction;
  final List<Order> order;
  final bool cod;
  final double orderTotal;
  MultiplePaymentSuccessMobile(
      {@required this.transaction,
      @required this.order,
      @required this.cod,
      @required this.orderTotal});
  @override
  _MultiplePaymentSuccessMobileState createState() =>
      _MultiplePaymentSuccessMobileState();
}

class _MultiplePaymentSuccessMobileState
    extends State<MultiplePaymentSuccessMobile> {
  String username = "";
  String userphone = "";
  String sellername = "";
