...
class MultiplePaymentSuccessTablet extends StatefulWidget {
  final bool transaction;
  final List<Order> order;
  final bool cod;
  final double orderTotal;
  MultiplePaymentSuccessTablet(
      {@required this.transaction,
      @required this.order,
      @required this.cod,
      @required this.orderTotal});
  @override
  _MultiplePaymentSuccessTabletState createState() =>
      _MultiplePaymentSuccessTabletState();
}

class _MultiplePaymentSuccessTabletState
    extends State<MultiplePaymentSuccessTablet> {
  String username = "";
  String userphone = "";
  String sellername = "";
