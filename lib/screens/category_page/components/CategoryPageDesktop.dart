...
class CategoryPageDesktop extends StatefulWidget {
  ...
  final String title;
  CategoryPageDesktop({this.categoryId, this.title});
  @override
  _CategoryPageDesktopState createState() =>
      _CategoryPageDesktopState(categoryId: categoryId);
}

class _CategoryPageDesktopState extends State<CategoryPageDesktop> {
  final String categoryId;
  _CategoryPageDesktopState({this.categoryId});
