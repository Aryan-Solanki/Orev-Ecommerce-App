...
class OfferzoneCategoryTablet extends StatefulWidget {
  final Function() notifyParent;
  OfferzoneCategoryTablet({this.notifyParent});
  @override
  _OfferzoneCategoryTabletState createState() =>
      _OfferzoneCategoryTabletState();
}

class _OfferzoneCategoryTabletState extends State<OfferzoneCategoryTablet> {
