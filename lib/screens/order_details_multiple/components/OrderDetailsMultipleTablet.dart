...
class OrderDetailsMultipleTablet extends StatefulWidget {
  const OrderDetailsMultipleTablet({
    Key key,
  ...
  @override
  _OrderDetailsMultipleTabletState createState() =>
      _OrderDetailsMultipleTabletState(totalCost: totalCost);
}

class _OrderDetailsMultipleTabletState
    extends State<OrderDetailsMultipleTablet> {
  double totalCost;

  _OrderDetailsMultipleTabletState({this.totalCost});
