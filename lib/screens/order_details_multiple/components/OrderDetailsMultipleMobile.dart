...
class OrderDetailsMultipleMobile extends StatefulWidget {
  const OrderDetailsMultipleMobile({
    Key key,
  ...
  @override
  _OrderDetailsMultipleMobileState createState() =>
      _OrderDetailsMultipleMobileState(totalCost: totalCost);
}

class _OrderDetailsMultipleMobileState
    extends State<OrderDetailsMultipleMobile> {
  double totalCost;

  _OrderDetailsMultipleMobileState({this.totalCost});
