...
class DetailsScreenTablet extends StatefulWidget {
  ...
  @override
  _DetailsScreenTabletState createState() => _DetailsScreenTabletState();
}
...
class _DetailsScreenTabletState extends State<DetailsScreenTablet> {
  ...
  // void sendSms() async {
  //   twilioFlutter.sendSMS(toNumber: '+919540014357', messageDetailsScreenTablet: 'aryan twilio msg');
  // }
