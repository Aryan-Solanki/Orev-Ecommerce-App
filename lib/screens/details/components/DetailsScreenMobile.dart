...
class DetailsScreenMobile extends StatefulWidget {
  ...
  @override
  _DetailsScreenMobileState createState() => _DetailsScreenMobileState();
}
...
class _DetailsScreenMobileState extends State<DetailsScreenMobile> {
  ...
  // void sendSms() async {
  //   twilioFlutter.sendSMS(toNumber: '+919540014357', messageDetailsScreenMobile: 'aryan twilio msg');
  // }
