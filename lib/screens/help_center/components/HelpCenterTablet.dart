...
class HelpCenterTablet extends StatefulWidget {
  @override
  _HelpCenterTabletState createState() => _HelpCenterTabletState();
}

class _HelpCenterTabletState extends State<HelpCenterTablet> {
  @override
