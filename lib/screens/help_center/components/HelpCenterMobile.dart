...
class HelpCenterMobile extends StatefulWidget {
  @override
  _HelpCenterMobileState createState() => _HelpCenterMobileState();
}

class _HelpCenterMobileState extends State<HelpCenterMobile> {
  @override
