...
class LikeScreenMobile extends StatefulWidget {
  @override
  _LikeScreenMobileState createState() => _LikeScreenMobileState();
}

class _LikeScreenMobileState extends State<LikeScreenMobile> {
