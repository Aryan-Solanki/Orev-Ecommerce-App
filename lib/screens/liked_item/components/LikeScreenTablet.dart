...
class LikeScreenTablet extends StatefulWidget {
  @override
  _LikeScreenTabletState createState() => _LikeScreenTabletState();
}

class _LikeScreenTabletState extends State<LikeScreenTablet> {
